...
def SP_with_CB (n,m,q,tt,pt,b_input,b_output,Big_M,Initial_Variables,LB_on_Obj_Fun,UB_on_Obj_Fun,Number_of_Thread,SP_Time_Limit):

    Mobile_Buffer_Policy=1
    Initial_Solution=1
    ...
    # Set 5: at most q number of AGVs are used 
    ...
    # Set 6: If an AGV leaves the depot it should return to depot later.
    var = [] 
    coe = []
    for node in delta_out_for_origin:
        var.append(f"y_{['0']},{node}")
    ...
    # Set 7-1: flow conservation constraints 
    ...
    # Set 7-2: flow conservation constraints 
    ...
    # Set 7-3: flow conservation constraints 
    ...
    # Set 7-4: flow conservation constraints 
    ...
    # Set 7-5: flow conservation constraints 
    ...
    # Set 7-6: flow conservation constraints 
    ...
    # Set 8: Only one of (j,i,0) or (j,i,-1) is selected
    ...
    # Set 10-1: the starting time of the transportation activity node v performed after (j,i,0):
    ...
    # Set 10-2: the starting time of the transportation activity node (j,i,0) performed after 0:
    ...
    # Set 10-3: the starting time of the transportation activities (j,i,1):
    for j in range(n):
        for i in range(m-1):
            h=0
            for node in delta_out_for_one_node[j*(m-1)+i]:
    ...
    # Set 10-4: the starting time of the transportation activity node (j,i,+1) performed after 0:
    for j in range(n):
        for i in range(m-1):
            var = [] 
            coe = []    
    ...
    # Set 10-5: the starting time of the transportation activities (j,i,-1):
    ...
    # Set 10-6: the starting time of the transportation activity node (j,i,-1) performed after 0:
    for j in range(n):
        for i in range(m-1):
            var = [] 
            coe = []    
    ...
    # Set 10-6: the starting time of the transportation activity node (j,i,-1) performed after v:
    #for j in range(n):
    #    for i in range(m-1):
    #        h=0
    #        for node in delta_in_for_negative_one_node[j*(m-1)+i]:
    ...
    # Set 11: the starting time of the transportation activities (j,i,1) is larger than the starting time of (j,i,-1):
    for j in range(n):
        for i in range(m-1):
            var = [] 
            coe = []
    ...
    # Set 12: the unloading time of jobs into output buffer of machines is larger than their starting time + processing time
    for i in range (1,m+1):
        for k in range(1, n + 1):
                    var = [] 
                    coe = []
    ...
    # Set 13-1: the unloading time of jobs into output buffer of machines is larger the starting time of transportaing the preceding job in the output buffer 
    for i in range (1, m):
    ...
    # Set 13-2: the unloading time of jobs into output buffer of machines is larger the starting time of transportaing the preceding job in the output buffer 
    for i in range (1, m):
        for k in range(b_output[i-1]+1, n + 1):
                    for j in range(1, n+1):
                        var = [] 
    ...
    # Set 14:  the starting time of processing a job on a machine  is larger than the inloading time of the preceeding job
    for i in range (1, m):
    ...
    # Set 15-1:  the starting time of transportation a job on a machine is larger than the starting time of transportation the preceeding job
    #for i in range (1, m):
    #    for k in range(2, n + 1):
    #        for kk in range (1,k):
    #            for j in range (1, n + 1):
    ...
    # Set 15-2:  the starting time of transportation a job on a machine is larger than the starting time of transportation the preceeding job
    #for i in range (1, m):
    #    for k in range(2, n + 1):
    #        for kk in range (1,k):
    #            for j in range (1, n + 1):
    ...
    # Set 15-3:  the starting time of transportation a job on a machine is larger than the starting time of transportation the preceeding job
    #for i in range (1, m):
    #    for k in range(2, n + 1):
    #        for kk in range (1,k):
    #            for j in range (1, n + 1):
    ...
    # Set 15-4:  the starting time of transportation a job on a machine is larger than the starting time of transportation the preceeding job
    #for i in range (1, m):
    #    for k in range(2, n + 1):
    #        for kk in range (1,k):
    #            for j in range (1, n + 1):
    ...
    # Set 16-1:  the starting time of transportation a job on a machine is larger than its unloading time on the output buffer:
    for i in range (1, m): 
        for k in range(1, n + 1):
                for j in range (1, n + 1):
                    var = [] 
    ...
    # Set 16-2:  the starting time of transportation a job on a machine is larger than its unloading time on the output buffer:
    for i in range (1, m): 
        for k in range(1, n + 1):
                for j in range (1, n + 1):
                    var = [] 
    ...
    # Set 17: the starting time of processing time is larger than the unloading time of jobs into input  buffer of machines
    for i in range (1,m+1):
        for k in range(1, n + 1):
                    var = [] 
                    coe = []
    ...
    # Set 18: the unloading time of jobs into input buffer of machines is larger than the starting time of processing the preceding job in the output buffer 
    for i in range (1, m+1):
    ...
    # Set 19-1: the starting time of transportation is larger than the unloading [into input buffer]  of processing the preceding job + empty travel time
    for j in range(n):
        for i in range(m-1):
    ...
    # Set 19-2: the starting time of transportation is larger than the unloading [into unput buffer]  of the preceding job + empty travel time
    for j in range(n):
        for i in range(m-1):
    ...
    # Set 20-1: the unloading [into input buffer] of a job is larger than  the starting time of transportation + empty travel time
    for j in range(n):
        for i in range(m-1):
            for k in range(1, n + 1):
                var = [] 
    ...
    # Set 20-2: activated if AGVs can not be used as the mobile buffer
    ...
    # Set 21-1: the unloading [into input buffer] of a job is larger than  the starting time of transportation + empty travel time
    for j in range(n):
        for i in range(m-1):
            for k in range(1, n + 1):
                var = [] 
    ...
    # Set 21-2: activated if AGVs can not be used as the mobile buffer
    if Mobile_Buffer_Policy==0: 
        for j in range(n):
            for i in range(m-1):
                for k in range(1, n + 1):
   ...
   #     Initial_Variables=['x_1,2,1', 'x_1,1,2', 'x_1,1,3', 'x_4,4,1', 'x_4,4,2', 'x_4,3,3', 'x_5,3,1', 'x_5,2,2', 'x_5,7,3', 'x_6,7,1', 'x_6,7,2', 'x_6,6,3', 'x_7,6,1', 'x_7,5,2', 'x_7,4,3']
    ...
    try:
        ...
        #         print(f"f_{Zero_Nodes[j][i]}",":",c.solution.get_values( f"f_{Zero_Nodes[j][i]}"))
